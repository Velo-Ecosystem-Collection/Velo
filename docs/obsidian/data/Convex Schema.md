...
- This is schema, validation, authorization, pure policy-evaluation, authenticated console CRUD, internal admission/submit lifecycle seams, Convex sponsor/submit orchestration, and the two D1 HTTP routes. Cleanup and relayer execution remain later work; submit does not imply queued or network activity.
