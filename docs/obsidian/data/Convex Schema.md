...
- This is schema, validation, authorization, pure policy-evaluation, authenticated console CRUD, internal admission, and Convex sponsor orchestration. The Next.js HTTP route, cleanup, and relayer execution remain later work.
